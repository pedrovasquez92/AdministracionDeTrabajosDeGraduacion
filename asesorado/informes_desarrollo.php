          ...
          <!-- Your Page Content Here -->
            <div class="row">
               <div class="col-md-6">
                 ...
                 <span class="info-box-icon"><i class="fa fa-check-circle"></i></span>
                  ...
                  <span class="info-box-number">Enviado</span>
                  <div class="progress">
            ...
            <div class="row">
               <div class="col-md-6">
                 ...
                 <span class="info-box-icon"><i class="fa fa-clock-o"></i></span>
                  ...
                  <span class="info-box-number">Enviar</span>
                  <div class="progress">
                  <div class="progress-bar" style="width: 100%"></div>
                      </div>
                  <input type="file" id="info2" size="1" style="opacity: 0; position: absolute;" accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document"/>
                      Subir Informe
            ...
            <div class="row">
               <div class="col-md-6">
                 ...
                 <input type="file" id="info3" size="1" style="opacity: 0; position: absolute;" accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document"/>
                      Subir Informe
            </div><!-- /.info-box-content -->
          </div><!-- /.info-box -->
                </div>
               ...
               <div class="col-md-6">
                 <div class="info-box bg-gray">
                  ...
                  <div class="progress-bar" style="width: 100%"></div>
                      ...
                      <span class="progress-description">Se agotó el tiempo de subida </span>
            </div><!-- /.info-box-content -->
          </div><!-- /.info-box -->
                </div>
            </div>
            <div class="row">
               <div class="col-md-6">
                 ...
                 <span class="info-box-icon"><i class="fa fa-clock-o"></i></span>
                  ...
                  <input type="file" id="info5" size="1" style="opacity: 0; position: absolute;" accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document"/>
                      Subir Informe
            </div><!-- /.info-box-content -->
          </div><!-- /.info-box -->
                </div>
